...
import { themes, generateThemeCSS } from '../constants/themes';
...
const ThemeSwitcher = () => {
    ...
    useEffect(() => {
        ...
        style.textContent = generateThemeCSS(currentTheme);
                    ...
                    <div className="p-2">
                        {Object.entries(themes).map(([key, theme]) => (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3 py-2 rounded-md text-left transition-colors duration-200 ${currentTheme === key
